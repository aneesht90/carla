        ...
        for episode in range(0, number_of_episodes):
            ...
            if store_vehicle_data:
                df = pd.DataFrame.from_records(datas,
                                           columns=['no', 'brake', 'throttle','velocity','acceleration-x','acceleration-y','acceleration-z'])
                save_file_name = "./Measurements/data_records_episode" + str(episode) + ".csv"
    ...
    while True:
        try:
            ...
            run_carla_client(
                ...
                store_vehicle_data=args.vehicle_data)
